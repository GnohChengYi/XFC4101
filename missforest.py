### Taken from https://github.com/SamsungSAILMontreal/ForestDiffusion/blob/main/missforest.py
# the original code in missingpy uses a very old version of sklearn (0.20.1)
# the authors of ForestDiffusion updated the code to be compatible with the new sklearn (1.2.1)
